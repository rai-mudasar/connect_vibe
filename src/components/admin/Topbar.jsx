        ...
        <div className="relative">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <div className="flex items-center gap-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 transition cursor-pointer">
                <Avatar className="w-10 h-10 border md:border-0 border-white bg-neutral-300">
                  <SafeImage
            ...
            <DropdownMenuContent className={"w-50 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg z-50 py-1 mr-5"}>
              <DropdownMenuItem>
                <Link href={'/home'} className="px-4 py-2 border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer">
              ...
              <DropdownMenuItem>
                <button
                  ...
                  className="w-full text-left px-4 py-2 text-sm flex items-center gap-2 text-red-600 dark:text-red-400 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer"
                >
