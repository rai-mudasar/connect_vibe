    ...
    return (
        <div>
            ...
            <div className="w-[88vw] md:[69vw] flex flex-row gap-5 mt-3 px-3 pb-8 overflow-x-scroll hide-scrollbar relative">
                <div className='h-full w-full flex justify-center items-center absolute -mt-8 md:-mx-37'> <Loader2 className="h-14 w-14 text-primary animate-spin" /></div>
                <div className="w-32 md:w-40 h-49 md:h-65 shrink-0 shadow-xl rounded-lg overflow-hidden bg-bg"></div>
                <div className="w-32 md:w-40 h-49 md:h-65 shrink-0 shadow-xl rounded-lg overflow-hidden bg-bg"></div>
                <div className="w-32 md:w-40 h-49 md:h-65 shrink-0 shadow-xl rounded-lg overflow-hidden bg-bg"></div>
                <div className="w-32 md:w-40 h-49 md:h-65 shrink-0 shadow-xl rounded-lg overflow-hidden bg-bg"></div>
                <div className="w-32 md:w-40 h-49 md:h-65 shrink-0 shadow-xl rounded-lg overflow-hidden bg-bg"></div>
